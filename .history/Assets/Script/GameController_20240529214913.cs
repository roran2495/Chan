...
public class GameController : MonoBehaviour
{
    ...
    public static void StartCountdown(TextMeshProUGUI countdownText)
    {
    ...
    private static System.Collections.IEnumerator CountdownRoutine(TextMeshProUGUI countdownText)
    {
        int remainingTime = 5;
