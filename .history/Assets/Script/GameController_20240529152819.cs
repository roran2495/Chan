...
public class GameController : MonoBehaviour
{
    ...
    public void ResetPlayerPosition()
    {
        ...
        CharacterController characterController = this.transform.GetComponent<CharacterController>();
        ...
        // 计算从当前位置到新位置的移动向量
        Vector3 moveDirection = newPosition - characterController.transform.position;
