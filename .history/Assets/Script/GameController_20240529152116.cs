...
public class GameController : MonoBehaviour
{
    ...
    {
        this.transform.GetComponent<CharacterController>().transform.position = new Vector3(2.5f , 0 , 0);
        this.transform.GetComponent<CharacterController>().transform.rotation = Quaternion.Euler(0, 0, 0);
    }
}
