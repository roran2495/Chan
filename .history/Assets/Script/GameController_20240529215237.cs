...
public class GameController : MonoBehaviour
{
    ...
    public void Resume(bool isPlayerReset)
    {
        ...
        canvas.gameObject.SetActive(false);
        StartCountdown(text.GetComponent<TM>)
        ResumeGame();
    }
    ...
    public void StartCountdown(TextMeshProUGUI countdownText)
    {
    ...
    private System.Collections.IEnumerator CountdownRoutine(TextMeshProUGUI countdownText)
    {
        int remainingTime = 5;
